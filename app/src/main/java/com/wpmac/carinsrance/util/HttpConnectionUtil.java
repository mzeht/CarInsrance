...
import com.wpmac.carinsrance.confirgation.Constants;
		...
		try {
			...
			HttpClient httpClient = HttpConnectionUtil.getNewHttpClient();
			   HttpGet httpGet = new HttpGet(url);
				httpGet.setHeader("X-LC-Id","xQLsCJnfsBKIbAYDGUpXrLgV-gzGzoHsz");
			httpGet.addHeader("X-LC-Key","9Cy0zWB3wcQvS6vrUBMkFo82");
